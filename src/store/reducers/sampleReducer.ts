...
export const initState: Portfolio = {
    brand: 'My Portfolio', // Add the brand property here
    meta: {
        title: 'My Portfolio',
        ...
        tools: [
            {
                ...
                description: 'A list of software tools and expertise.',
            },
            {
                name: 'Awards & Publications',
                list: 'LookieLookie 2018, BigTime Magazine',
                description: 'A list of Awards & Publications.'
            },
            {
                name: 'Utilities',
                list: 'Git, npm, at least',
                description: 'A list of utilities and tools.',
            },
        ],
    },
    sections: [
